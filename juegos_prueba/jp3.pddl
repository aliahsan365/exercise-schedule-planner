...
(:init
  ...
  (ejercicio_preparable ejercicio3)
  (ejercicio_preparador ejercicio3 ejercicio2)
  (ejercicio_preparador ejercicio3 ejercicio1)
  (ejercicio_precedible ejercicio6)
  (ejercicio_precursor ejercicio6 ejercicio5)
)
(:goal (and
    (ejercicio_nivel ejercicio4 nivel6)
    (ejercicio_nivel ejercicio6 nivel6)
  )
)
)
