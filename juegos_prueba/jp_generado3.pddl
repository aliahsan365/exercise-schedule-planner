...
(ejercicio_nivel ejercicio2 nivel3)
(ejercicio_nivel ejercicio3 nivel1)
...
(ejercicio_preparador ejercicio1 ejercicio2)
(ejercicio_preparable ejercicio5)
(ejercicio_preparador ejercicio5 ejercicio1)
(ejercicio_preparable ejercicio4)
(ejercicio_preparador ejercicio4 ejercicio2)
)

(:goal (and
(ejercicio_nivel ejercicio5 nivel9)
(ejercicio_nivel ejercicio4 nivel8)
(ejercicio_nivel ejercicio1 nivel10)
)
)
)
